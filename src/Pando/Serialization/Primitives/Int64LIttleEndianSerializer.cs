...
public class Int64LittleEndianSerializer : IPandoSerializer<long>
{
	...
	public void Serialize(long value, Span<byte> buffer, INodeDataStore dataStore) => BinaryPrimitives.WriteInt64LittleEndian(buffer, value);
	public long Deserialize(ReadOnlySpan<byte> buffer, IReadOnlyNodeDataStore dataStore) => BinaryPrimitives.ReadInt64LittleEndian(buffer);
}
