...
public class UInt64LittleEndianSerializer : IPandoSerializer<ulong>
{
	...
	public void Serialize(ulong value, Span<byte> buffer, INodeDataSink _) => BinaryPrimitives.WriteUInt64LittleEndian(buffer, value);

	public ulong Deserialize(ReadOnlySpan<byte> buffer, INodeDataSource _) => BinaryPrimitives.ReadUInt64LittleEndian(buffer);
}
