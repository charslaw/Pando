...
public class ChessTests
{
	...
	public async Task SaveToJson()
	{
		...
		var vault = await MemoryNodeVault.Create(jsonPersistor);
		var repository = new PandoRepository<ChessGameState>(vault, new MemorySnapshotVault(), MakeSerializer());
		...
		var expectedInitialJson = """
			{"NodeId":"685ae5b45d51f705","Bytes":"0005024100000502420000050243000005024400000502450000050246000005024700000502480000020141000004014200000301430000010144000000014500000301460000040147000002014800"}
			{"NodeId":"16a1d0025283dba9","Bytes":"0105074100010507420001050743000105074400010507450001050746000105074700010507480001020841000104084200010308430001010844000100084500010308460001040847000102084800"}
			{"NodeId":"5be63be903c87808","Bytes":"0000005ED0B200000000005ED0B200000000685AE5B45D51F70516A1D0025283DBA9"}
		...
		var expectedFirstMoveJson = """
			...
			{"NodeId":"16a1d0025283dba9","Bytes":"0105074100010507420001050743000105074400010507450001050746000105074700010507480001020841000104084200010308430001010844000100084500010308460001040847000102084800"}
			{"NodeId":"5be63be903c87808","Bytes":"0000005ED0B200000000005ED0B200000000685AE5B45D51F70516A1D0025283DBA9"}
			{"NodeId":"2965c8539de6f372","Bytes":"0005024100000502420000050243000005024400000504450000050246000005024700000502480000020141000004014200000301430000010144000000014500000301460000040147000002014800"}
			{"NodeId":"9b6024556565dff8","Bytes":"010040CB4CB100000000005ED0B2000000002965C8539DE6F37216A1D0025283DBA9"}
